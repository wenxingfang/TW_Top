...
#include "/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/ee_channel/MVA/F_MVA_20180608.C"
...
MVA_Reader_0j0t* Reader_BDT_0j0t=new MVA_Reader_0j0t("MLP");
MVA_Reader_1j0t* Reader_BDT_1j0t=new MVA_Reader_1j0t("MLP");
MVA_Reader_1j1t* Reader_BDT_1j1t=new MVA_Reader_1j1t("MLP");
MVA_Reader_2j1t* Reader_BDT_2j1t=new MVA_Reader_2j1t("MLP");
...
TString output_dir="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/ee_channel/ntuples/saved_hist/Step2_20180623_top_pt_reweight/";
//
TString str_uncert="";
TString uncertainty="";
...
if(same_sign.Contains("samesign")){ select_same_sign=true;
                                    output_dir="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/ee_channel/ntuples/saved_hist/Step2_SameSign_20180623_top_pt_reweight/";
                                  }
////////////////////////////////// trigger ///////////////////////////////////////////////
/*
...
*/
if(s_uncert.Contains("PDF")==false && s_uncert.Contains("QCD_")==false){
/*
//////// FCNC ///
if(s_uncert.Contains("FCNC_PS_Down")){
fill_hist(input_dir_sys+"FCNC_ST_tug_PS_Down.root"               ,output_dir+"ee_"+uncertainty+"_.root"  , "FCNC_ST_tug"           ,false,false,false,uncertainty,1,false,false);
fill_hist(input_dir_sys+"FCNC_ST_tcg_PS_Down.root"               ,output_dir+"ee_"+uncertainty+"_.root"  , "FCNC_ST_tcg"           ,false,false,false,uncertainty,1,false,false);
}
else if(s_uncert.Contains("FCNC_PS_Up")){
fill_hist(input_dir_sys+"FCNC_ST_tug_PS_Up.root"                 ,output_dir+"ee_"+uncertainty+"_.root"  , "FCNC_ST_tug"           ,false,false,false,uncertainty,1,false,false);
fill_hist(input_dir_sys+"FCNC_ST_tcg_PS_Up.root"                 ,output_dir+"ee_"+uncertainty+"_.root"  , "FCNC_ST_tcg"           ,false,false,false,uncertainty,1,false,false);
}
else{
...
fill_hist(input_dir_sys+s_uncert+".root"                         ,output_dir+"ee_"  +uncertainty+"_.root", "TTTo2L2Nu"             ,false,false,false,uncertainty,1,use_top_weight,false);
...
else if(s_uncert.Contains("TT_PDF") || s_uncert.Contains("TT_QCD_")){
fill_hist(input_dir_sys+"TT_PDF_To2L2Nu.root"                    ,output_dir+"ee_"+uncertainty+"_.root", "TTTo2L2Nu"             ,false,false,false,uncertainty,1,use_top_weight,false);
}
else if(s_uncert.Contains("FCNC_PDF") || s_uncert.Contains("FCNC_QCD_")){
fill_hist(input_dir+"FCNC_ST_tug_fullsim.root"                   ,output_dir+"ee_"+uncertainty+"_.root", "FCNC_ST_tug"           ,false,false,false,uncertainty,1,false,false);
fill_hist(input_dir+"FCNC_ST_tcg_fullsim.root"                   ,output_dir+"ee_"+uncertainty+"_.root", "FCNC_ST_tcg"           ,false,false,false,uncertainty,1,false,false);
}
else if(s_uncert.Contains("DY_PDF") || s_uncert.Contains("DY_QCD_")){
fill_hist(input_dir+"DYJetsToLL_M50_amc_LHE.root"                ,output_dir+"ee_"+uncertainty+"_.root", "DYJetsToLL_M50_amc"    ,false,false,false,uncertainty,1,false,false);
}


////fill_hist(input_dir+"TT_inclusive.root"                          ,output_dir+"ee_"  +uncertainty+"_.root", "TT_inclusive"          ,false,false,false,uncertainty,1,false,false);
...
//////// FCNC ///
if(s_uncert.Contains("FCNC_PS_Down")){
fill_hist(input_dir_sys+"FCNC_ST_tug_PS_Down.root"               ,output_dir+"emu_"+uncertainty+"_.root" , "FCNC_ST_tug"           ,false,false,false,uncertainty,2,false,false);
fill_hist(input_dir_sys+"FCNC_ST_tcg_PS_Down.root"               ,output_dir+"emu_"+uncertainty+"_.root" , "FCNC_ST_tcg"           ,false,false,false,uncertainty,2,false,false);
}
else if(s_uncert.Contains("FCNC_PS_Up")){
fill_hist(input_dir_sys+"FCNC_ST_tug_PS_Up.root"                 ,output_dir+"emu_"+uncertainty+"_.root" , "FCNC_ST_tug"           ,false,false,false,uncertainty,2,false,false);
fill_hist(input_dir_sys+"FCNC_ST_tcg_PS_Up.root"                 ,output_dir+"emu_"+uncertainty+"_.root" , "FCNC_ST_tcg"           ,false,false,false,uncertainty,2,false,false);
}
else{
...
*/
if(s_uncert.Contains("TT")){
fill_hist(input_dir_sys+s_uncert+".root"                         ,output_dir+"emu_"  +uncertainty+"_.root", "TTTo2L2Nu"             ,false,false,false,uncertainty,2,use_top_weight,false);
...
fill_hist(input_dir_sys+"TT_PDF_To2L2Nu.root"                    ,output_dir+"emu_" +uncertainty+"_.root", "TTTo2L2Nu"            ,false,false,false,uncertainty,2,use_top_weight,false);
}
else if(s_uncert.Contains("FCNC_PDF") || s_uncert.Contains("FCNC_QCD_")){
fill_hist(input_dir+"FCNC_ST_tug_fullsim.root"                   ,output_dir+"emu_"+uncertainty+"_.root", "FCNC_ST_tug"           ,false,false,false,uncertainty,2,false,false);
fill_hist(input_dir+"FCNC_ST_tcg_fullsim.root"                   ,output_dir+"emu_"+uncertainty+"_.root", "FCNC_ST_tcg"           ,false,false,false,uncertainty,2,false,false);
...
fill_hist(input_dir+"DYJetsToLL_M50_amc_LHE.root"                ,output_dir+"emu_"+uncertainty+"_.root", "DYJetsToLL_M50_amc"    ,false,false,false,uncertainty,2,false,false);
}

////fill_hist(input_dir+"TT_inclusive.root"                          ,output_dir+"emu_"+uncertainty+"_.root", "TT_inclusive"          ,false,false,false,uncertainty,2,false,false);
////fill_hist(input_dir+"TTJets_Dilept.root"                         ,output_dir+"emu_"+uncertainty+"_.root", "TTJets_Dilept"         ,false,false,false,uncertainty,2,false,false);
////fill_hist(input_dir+"TTJets_madgraph.root"                       ,output_dir+"emu_"+uncertainty+"_.root", "TTJets_madgraph"       ,false,false,false,uncertainty,2,false,false);
////fill_hist(input_dir+"TT_TuneEE5C.root"                           ,output_dir+"emu_"+uncertainty+"_.root", "TT_TuneEE5C"           ,false,false,false,uncertainty,2,false,false);
}
...
//////// FCNC ///
if(s_uncert.Contains("FCNC_PS_Down")){
fill_hist(input_dir_sys+"FCNC_ST_tug_PS_Down.root"               ,output_dir+"mumu_"+uncertainty+"_.root", "FCNC_ST_tug"           ,false,false,false,uncertainty,3,false,false);
fill_hist(input_dir_sys+"FCNC_ST_tcg_PS_Down.root"               ,output_dir+"mumu_"+uncertainty+"_.root", "FCNC_ST_tcg"           ,false,false,false,uncertainty,3,false,false);
}
else if(s_uncert.Contains("FCNC_PS_Up")){
fill_hist(input_dir_sys+"FCNC_ST_tug_PS_Up.root"                 ,output_dir+"mumu_"+uncertainty+"_.root", "FCNC_ST_tug"           ,false,false,false,uncertainty,3,false,false);
fill_hist(input_dir_sys+"FCNC_ST_tcg_PS_Up.root"                 ,output_dir+"mumu_"+uncertainty+"_.root", "FCNC_ST_tcg"           ,false,false,false,uncertainty,3,false,false);
}
else{
...
*/
if(s_uncert.Contains("TT")){
fill_hist(input_dir_sys+s_uncert+".root"                         ,output_dir+"mumu_"  +uncertainty+"_.root", "TTTo2L2Nu"             ,false,false,false,uncertainty,3,use_top_weight,false);
...
fill_hist(input_dir_sys+"TT_PDF_To2L2Nu.root"                    ,output_dir+"mumu_" +uncertainty+"_.root", "TTTo2L2Nu"            ,false,false,false,uncertainty,3,use_top_weight,false);
}
else if(s_uncert.Contains("FCNC_PDF") || s_uncert.Contains("FCNC_QCD_")){
fill_hist(input_dir+"FCNC_ST_tug_fullsim.root"                   ,output_dir+"mumu_"+uncertainty+"_.root", "FCNC_ST_tug"           ,false,false,false,uncertainty,3,false,false);
fill_hist(input_dir+"FCNC_ST_tcg_fullsim.root"                   ,output_dir+"mumu_"+uncertainty+"_.root", "FCNC_ST_tcg"           ,false,false,false,uncertainty,3,false,false);
...
fill_hist(input_dir+"DYJetsToLL_M50_amc_LHE.root"                ,output_dir+"mumu_"+uncertainty+"_.root", "DYJetsToLL_M50_amc"    ,false,false,false,uncertainty,3,false,false);
}


////fill_hist(input_dir+"TT_inclusive.root"                          ,output_dir+"mumu_"+uncertainty+"_.root", "TT_inclusive"          ,false,false,false,uncertainty,3,false,false);
...
TH1D *H_xjet_1bjet         =new TH1D(name+"H_xjet_1bjet"      ,"",1 ,0 ,1   );
...
TH1D *H_MLP_tug_xjet_1bjet     =new TH1D(name+"H_MLP_tug_xjet_1bjet"  ,"",10,0     ,1   );
...
TH1D *H_MLP_tcg_xjet_1bjet     =new TH1D(name+"H_MLP_tcg_xjet_1bjet"  ,"",10,0     ,1   );
...
TH1D *H_MLP_1jet_1bjet_comb=new TH1D(name+"H_MLP_1jet_1bjet_comb"  ,"",5,0.2,0.7);
...
TH1D *H_BSM_xj1b_l1_pt          =new TH1D(name+"H_BSM_xj1b_l1_pt"         ,"",30 ,0 ,150);
TH1D *H_BSM_xj1b_Ptll           =new TH1D(name+"H_BSM_xj1b_Ptll"          ,"",40 ,0 ,200);
TH1D *H_BSM_xj1b_dPt_l1_l2      =new TH1D(name+"H_BSM_xj1b_dPt_l1_l2"     ,"",20 ,0 ,100); 
TH1D *H_BSM_xj1b_Mll            =new TH1D(name+"H_BSM_xj1b_Mll"           ,"",60 ,0 ,300); 
TH1D *H_BSM_xj1b_Cll            =new TH1D(name+"H_BSM_xj1b_Cll"           ,"",20 ,0 ,1  );
TH1D *H_BSM_xj1b_ll_j1_pt       =new TH1D(name+"H_BSM_xj1b_ll_j1_pt"      ,"",40 ,0 ,200); 
TH1D *H_BSM_xj1b_dR_ll_j1       =new TH1D(name+"H_BSM_xj1b_dR_ll_j1"      ,"",60 ,0 ,6  ); 
TH1D *H_BSM_xj1b_M_l2_j1        =new TH1D(name+"H_BSM_xj1b_M_l2_j1"       ,"",50 ,0 ,500);
TH1D *H_BSM_xj1b_Cl1_j1         =new TH1D(name+"H_BSM_xj1b_Cl1_j1"        ,"",20 ,0 ,1  ); 
...
TH1D *H_Rinout_Mll_NoMET_all  = new TH1D(name+"H_Rinout_Mll_NoMET_all"        ,"",3 ,Mass_bin);
TH1D *H_Rinout_Mll_NoMET_0j0b = new TH1D(name+"H_Rinout_Mll_NoMET_0j0b"       ,"",3 ,Mass_bin);
TH1D *H_Rinout_Mll_NoMET_1j0b = new TH1D(name+"H_Rinout_Mll_NoMET_1j0b"       ,"",3 ,Mass_bin);
TH1D *H_Rinout_Mll_NoMET_1j1b = new TH1D(name+"H_Rinout_Mll_NoMET_1j1b"       ,"",3 ,Mass_bin);
TH1D *H_Rinout_Mll_NoMET_2j1b = new TH1D(name+"H_Rinout_Mll_NoMET_2j1b"       ,"",3 ,Mass_bin);
TH1D *H_Rinout_Mll_NoMET_2j2b = new TH1D(name+"H_Rinout_Mll_NoMET_2j2b"       ,"",3 ,Mass_bin);
///////////////////////////////////////////////////////
const Int_t nx = 5;
...
TH1D  *w_Nvtx_mumu  = (TH1D*)Nvtx_Map_mumu->Get("H_pv_n");
*/
TString txt_name=output_file;
txt_name.ReplaceAll(".root",".txt"); 
//ofstream fout(txt_name);
ofstream fout("Wx_ee.txt");
...
///////////////////////////////////////////////////////////
//if(llp4.M()>80 || (llp4.M()<80 && MET_T1Txy_et>40)) pass_2=true;//
pass_2=true;//
...
//////////////// PDF weight ////////////////////
float PDF_Weight=1;
if(uncert.Contains("PDF") && LHE_sys_id->empty()==false){
for(unsigned int it=0;it<LHE_sys_id->size();it++){
TString TT_str_tmp="TT_PDF_";
TString FCNC_str_tmp="FCNC_PDF_";
TString DY_str_tmp="DY_PDF_";
TT_str_tmp+=int(LHE_sys_id->at(it));
FCNC_str_tmp+=int(LHE_sys_id->at(it));
DY_str_tmp+=int(LHE_sys_id->at(it));
if(TT_str_tmp==uncert || FCNC_str_tmp==uncert || DY_str_tmp==uncert ){PDF_Weight=LHE_sys_weight->at(it);break;}
}
}
//std::cout<<"PDF:"<<PDF_Weight<<std::endl;
//////////////// QCD weight ////////////////////
float QCD_Weight=1;
if(sample_name.Contains("TTTo2L2Nu") || sample_name.Contains("FCNC_ST_") || sample_name.Contains("DYJetsToLL_")){
if((uncert.Contains("TT_QCD_")||uncert.Contains("FCNC_QCD_")||uncert.Contains("DY_QCD_")) && LHE_sys_id->empty()==false){
for(unsigned int it=0;it<LHE_sys_id->size();it++){
TString TT_str_tmp="TT_QCD_";
TString FCNC_str_tmp="FCNC_QCD_";
TString DY_str_tmp="DY_QCD_";
TT_str_tmp+=int(LHE_sys_id->at(it));
FCNC_str_tmp+=int(LHE_sys_id->at(it));
DY_str_tmp+=int(LHE_sys_id->at(it));
if(TT_str_tmp==uncert || FCNC_str_tmp==uncert || DY_str_tmp==uncert ){QCD_Weight=LHE_sys_weight->at(it);break;}
}
}
}
//////////////// event weight ////////////////////
event_weight=event_weight*sf_Ele_reco*sf_Ele_ID*sf_Muon_track*sf_Muon_ID*sf_Muon_Iso*sf_Btag*sf_trigger*PDF_Weight*QCD_Weight;
...
if(pass_1 ){
if(76<llp4.M() && llp4.M()<106) fout<<ev_run<<" "<<ev_luminosityBlock<<" "<<ev_event<<"\n";
                                             fill(H_Rinout_Mll_NoMET_all ,llp4.M(),event_weight);
if(Num_loose_jet ==0 && Num_b_jet ==0 )      fill(H_Rinout_Mll_NoMET_0j0b,llp4.M(),event_weight);
else if(Num_loose_jet ==1 && Num_b_jet ==0 ) fill(H_Rinout_Mll_NoMET_1j0b,llp4.M(),event_weight);
else if(Num_loose_jet ==1 && Num_b_jet ==1 ) fill(H_Rinout_Mll_NoMET_1j1b,llp4.M(),event_weight);
else if(Num_loose_jet ==2 && Num_b_jet ==1 ) fill(H_Rinout_Mll_NoMET_2j1b,llp4.M(),event_weight);
else if(Num_loose_jet >=2 && Num_b_jet ==2 ) fill(H_Rinout_Mll_NoMET_2j2b,llp4.M(),event_weight);
}
///////////////////////For Final plot//////////////////////////////////////
//if(pass_1 ){
if(pass_1 && pass_2){
...
//-------------- For FCNC 1bjet region -----------------------
if     (Num_b_jet ==1 ){ 
                        H_xjet_1bjet->Fill(0.5,event_weight);
                        fill(H_MLP_tug_xjet_1bjet    ,Reader_MLP_tug->Eval(),event_weight); 
                        fill(H_MLP_tcg_xjet_1bjet    ,Reader_MLP_tcg->Eval(),event_weight); 
                        fill(H_BSM_xj1b_l1_pt        ,Reader_MLP_BSM->v1    ,event_weight);
                        fill(H_BSM_xj1b_Ptll         ,Reader_MLP_BSM->v2    ,event_weight);
                        fill(H_BSM_xj1b_dPt_l1_l2    ,Reader_MLP_BSM->v3    ,event_weight);
                        fill(H_BSM_xj1b_Mll          ,Reader_MLP_BSM->v4    ,event_weight);
                        fill(H_BSM_xj1b_Cll          ,Reader_MLP_BSM->v5    ,event_weight);
                        fill(H_BSM_xj1b_ll_j1_pt     ,Reader_MLP_BSM->v6    ,event_weight);
                        fill(H_BSM_xj1b_dR_ll_j1     ,Reader_MLP_BSM->v7    ,event_weight);
                        fill(H_BSM_xj1b_M_l2_j1      ,Reader_MLP_BSM->v8    ,event_weight);
                        fill(H_BSM_xj1b_Cl1_j1       ,Reader_MLP_BSM->v9    ,event_weight);
                       }
//-------------------------------------
if     (Num_loose_jet ==0 && Num_b_jet ==0 ){ H_Limit_N_jet_bjet->Fill(0.5,event_weight);
                                             ...
                                             //------------ tw meausrement---------------------------------------------------
                                              ...
                                              Reader_MLP_0j0t->v2=llp4.Pt();
                                              Reader_MLP_0j0t->v3=fabs(lepton_led.Pt()-lepton_sub.Pt());
                                              Reader_MLP_0j0t->v4=llp4.M();
                                              Reader_MLP_0j0t->v5=(lepton_led.Pt()+lepton_sub.Pt())/(lepton_led+lepton_sub).E();
                                              Reader_BDT_0j0t->v1=lepton_led.Pt();
                                              //Reader_BDT_0j0t->v2=float(Num_loose_jet_low);
                                              Reader_BDT_0j0t->v2=llp4.Pt();
                                              Reader_BDT_0j0t->v3=fabs(lepton_led.Pt()-lepton_sub.Pt());
                                              Reader_BDT_0j0t->v4=llp4.M();
                                              Reader_BDT_0j0t->v5=(lepton_led.Pt()+lepton_sub.Pt())/(lepton_led+lepton_sub).E();
                                              ...
                                              fill(H_0j0b_N_loose_jets_low,0                      ,event_weight);
                                              fill(H_0j0b_Ptll            ,Reader_MLP_0j0t->v2    ,event_weight);
                                              fill(H_0j0b_dPt_l1_l2       ,Reader_MLP_0j0t->v3    ,event_weight);
                                              fill(H_0j0b_Mll             ,Reader_MLP_0j0t->v4    ,event_weight);
                                              fill(H_0j0b_Cll             ,Reader_MLP_0j0t->v5    ,event_weight);
                                             ...
                                             //------------ tw meausrement---------------------------------------------------
                                              ...
                                              Reader_MLP_1j0t->v2=llp4.Pt();
                                              Reader_MLP_1j0t->v3=fabs(lepton_led.Pt()-lepton_sub.Pt());
                                              Reader_MLP_1j0t->v4=llp4.M();
                                              Reader_MLP_1j0t->v5=(lepton_led.Pt()+lepton_sub.Pt())/(lepton_led+lepton_sub).E();
                                              Reader_MLP_1j0t->v6=(lepton_led.Pt()+led_jet_tmp_p4.Pt())/(lepton_led + led_jet_tmp_p4).E();
                                              Reader_MLP_1j0t->v7=deltaPhi((lepton_led+lepton_sub).Phi(),led_jet_tmp_p4.Phi());
                                              Reader_BDT_1j0t->v1=lepton_led.Pt();
                                              //Reader_BDT_1j0t->v2=float(Num_loose_jet_low);
                                              Reader_BDT_1j0t->v2=llp4.Pt();
                                              Reader_BDT_1j0t->v3=fabs(lepton_led.Pt()-lepton_sub.Pt());
                                              Reader_BDT_1j0t->v4=llp4.M();
                                              Reader_BDT_1j0t->v5=(lepton_led.Pt()+lepton_sub.Pt())/(lepton_led+lepton_sub).E();
                                              Reader_BDT_1j0t->v6=(lepton_led.Pt()+led_jet_tmp_p4.Pt())/(lepton_led + led_jet_tmp_p4).E();
                                              Reader_BDT_1j0t->v7=deltaPhi((lepton_led+lepton_sub).Phi(),led_jet_tmp_p4.Phi());
                                              ...
                                              fill(H_1j0b_N_loose_jets_low,0                      ,event_weight);
                                              fill(H_1j0b_Ptll            ,Reader_MLP_1j0t->v2    ,event_weight);
                                              fill(H_1j0b_dPt_l1_l2       ,Reader_MLP_1j0t->v3    ,event_weight);
                                              fill(H_1j0b_Mll             ,Reader_MLP_1j0t->v4    ,event_weight);
                                              fill(H_1j0b_Cll             ,Reader_MLP_1j0t->v5    ,event_weight);
                                              fill(H_1j0b_Cl1_j1          ,Reader_MLP_1j0t->v6    ,event_weight);
                                              fill(H_1j0b_dPhi_ll_j1      ,Reader_MLP_1j0t->v7    ,event_weight);
                                             ...
                                             */
                                             ...
                                             Reader_MLP_1j1t->v1= (led_jet_tmp_p4+lepton_led+lepton_sub).Pt();
                                             Reader_MLP_1j1t->v2=lepton_led.DeltaR(led_jet_tmp_p4);
                                             Reader_MLP_1j1t->v3=lepton_led.DeltaR(lepton_sub);
                                             Reader_MLP_1j1t->v4=deltaPhi((lepton_led+lepton_sub).Phi(),led_jet_tmp_p4.Phi());
                                             Reader_MLP_1j1t->v5=(lepton_led.Pt()+lepton_sub.Pt() + led_jet_tmp_p4.Pt())/(lepton_led + lepton_sub + led_jet_tmp_p4).E();
                                             Reader_MLP_1j1t->v6=(lepton_led + led_jet_tmp_p4).Pt();
/*
...
*/
                                            ...
                                            // H_MLP_1jet_1bjet_DF  ->Fill(Reader_MLP_1j1t_DF->Eval(),event_weight); 
                                             ...
                                             fill(H_1j1b_led_Lowjet         ,0,event_weight);
                                             fill(H_1j1b_N_Lowbjet          ,0,event_weight);
                                             fill(H_1j1b_ll_j1_pt           ,Reader_MLP_1j1t->v1 ,event_weight);
                                             fill(H_1j1b_dR_l1_j1           ,Reader_MLP_1j1t->v2 ,event_weight);
                                             fill(H_1j1b_dR_l1_l2           ,Reader_MLP_1j1t->v3 ,event_weight);
                                             fill(H_1j1b_dPhi_ll_j1         ,Reader_MLP_1j1t->v4 ,event_weight);
                                             fill(H_1j1b_Cll_j1             ,Reader_MLP_1j1t->v5 ,event_weight);
                                             fill(H_1j1b_l1_j1_pt           ,Reader_MLP_1j1t->v6 ,event_weight);
                                             ...
                                             Reader_MLP_2j1t->v1=lepton_led.Pt();
                                             Reader_MLP_2j1t->v2=llp4.Pt();
                                             //Reader_MLP_2j1t->v4=sub_jet_tmp_p4.Pt() ;
                                             Reader_MLP_2j1t->v3=lepton_sub.Pt()- sub_jet_tmp_p4.Pt();
                                             Reader_MLP_2j1t->v4=lepton_led.DeltaR(sub_jet_tmp_p4);
                                             Reader_MLP_2j1t->v5=(lepton_led + lepton_sub).DeltaR(led_jet_tmp_p4);
                                             Reader_MLP_2j1t->v6=deltaPhi((lepton_led+lepton_sub).Phi(),led_jet_tmp_p4.Phi());
                                             Reader_MLP_2j1t->v7=(lepton_led + sub_jet_tmp_p4).Mag();
                                             Reader_MLP_2j1t->v8=(led_jet_tmp_p4+sub_jet_tmp_p4).Mag();
                                             //Reader_BDT_2j1t->v1=float(Num_loose_jet_low);
                                             Reader_BDT_2j1t->v1=lepton_led.Pt();
                                             Reader_BDT_2j1t->v2=llp4.Pt();
                                             //Reader_BDT_2j1t->v4=sub_jet_tmp_p4.Pt() ;
                                             Reader_BDT_2j1t->v3=lepton_sub.Pt()- sub_jet_tmp_p4.Pt();
                                             Reader_BDT_2j1t->v4=lepton_led.DeltaR(sub_jet_tmp_p4);
                                             Reader_BDT_2j1t->v5=(lepton_led + lepton_sub).DeltaR(led_jet_tmp_p4);
                                             Reader_BDT_2j1t->v6=deltaPhi((lepton_led+lepton_sub).Phi(),led_jet_tmp_p4.Phi());
                                             Reader_BDT_2j1t->v7=(lepton_led + sub_jet_tmp_p4).Mag();
                                             Reader_BDT_2j1t->v8=(led_jet_tmp_p4+sub_jet_tmp_p4).Mag();
                                             ...
                                             fill(H_2j1b_N_jet_low          ,0                      ,event_weight);
                                             fill(H_2j1b_l1_pt              ,Reader_MLP_2j1t->v1    ,event_weight);
                                             fill(H_2j1b_Ptll               ,Reader_MLP_2j1t->v2    ,event_weight);
                                             fill(H_2j1b_j2_pt              ,0                      ,event_weight);
                                             fill(H_2j1b_dPt_l2_j2          ,Reader_MLP_2j1t->v3    ,event_weight);
                                             fill(H_2j1b_dR_l1_j2           ,Reader_MLP_2j1t->v4    ,event_weight);
                                             fill(H_2j1b_dR_ll_j1           ,Reader_MLP_2j1t->v5    ,event_weight);
                                             fill(H_2j1b_dPhi_ll_j1         ,Reader_MLP_2j1t->v6    ,event_weight);
                                             fill(H_2j1b_M_l1_j2            ,Reader_MLP_2j1t->v7    ,event_weight);
                                             fill(H_2j1b_M_j1_j2            ,Reader_MLP_2j1t->v8    ,event_weight);
...
H_xjet_1bjet          ->Write("",TObject::kOverwrite);
H_MLP_tug_xjet_1bjet  ->Write("",TObject::kOverwrite);
H_MLP_tcg_xjet_1bjet  ->Write("",TObject::kOverwrite);
...
H_BSM_xj1b_l1_pt          ->Write("",TObject::kOverwrite); 
H_BSM_xj1b_Ptll           ->Write("",TObject::kOverwrite); 
H_BSM_xj1b_dPt_l1_l2      ->Write("",TObject::kOverwrite); 
H_BSM_xj1b_Mll            ->Write("",TObject::kOverwrite); 
H_BSM_xj1b_Cll            ->Write("",TObject::kOverwrite); 
H_BSM_xj1b_ll_j1_pt       ->Write("",TObject::kOverwrite); 
H_BSM_xj1b_dR_ll_j1       ->Write("",TObject::kOverwrite); 
H_BSM_xj1b_M_l2_j1        ->Write("",TObject::kOverwrite); 
H_BSM_xj1b_Cl1_j1         ->Write("",TObject::kOverwrite); 
...
H_Rinout_Mll_NoMET_all    ->Write("",TObject::kOverwrite); 
H_Rinout_Mll_NoMET_0j0b   ->Write("",TObject::kOverwrite); 
H_Rinout_Mll_NoMET_1j0b   ->Write("",TObject::kOverwrite); 
H_Rinout_Mll_NoMET_1j1b   ->Write("",TObject::kOverwrite); 
H_Rinout_Mll_NoMET_2j1b   ->Write("",TObject::kOverwrite); 
H_Rinout_Mll_NoMET_2j2b   ->Write("",TObject::kOverwrite); 
...
H_xjet_1bjet          ->Delete();
H_MLP_tug_xjet_1bjet  ->Delete();
H_MLP_tcg_xjet_1bjet  ->Delete();
H_MLP_all         ->Delete();
H_BDT_all         ->Delete();
H_MLP_all_v1      ->Delete();
H_BDT_all_v1      ->Delete();
...
H_BSM_xj1b_l1_pt          ->Delete(); 
H_BSM_xj1b_Ptll           ->Delete(); 
H_BSM_xj1b_dPt_l1_l2      ->Delete(); 
H_BSM_xj1b_Mll            ->Delete(); 
H_BSM_xj1b_Cll            ->Delete(); 
H_BSM_xj1b_ll_j1_pt       ->Delete(); 
H_BSM_xj1b_dR_ll_j1       ->Delete(); 
H_BSM_xj1b_M_l2_j1        ->Delete(); 
H_BSM_xj1b_Cl1_j1         ->Delete(); 
...
H_Rinout_Mll_NoMET_all    ->Delete(); 
H_Rinout_Mll_NoMET_0j0b   ->Delete(); 
H_Rinout_Mll_NoMET_1j0b   ->Delete(); 
H_Rinout_Mll_NoMET_1j1b   ->Delete(); 
H_Rinout_Mll_NoMET_2j1b   ->Delete(); 
H_Rinout_Mll_NoMET_2j2b   ->Delete(); 
