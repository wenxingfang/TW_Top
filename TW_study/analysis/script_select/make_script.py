...
#    uncertainty.append("TT_QCD_%s"%(str(ip)))    
############# Systematic sample ##############
...
##
############### FCNC PDF uncertainty ################
#for ip in range(10,111):
#    uncertainty.append("FCNC_PDF_%s"%(str(ip)))    
############### FCNC QCD : renormalization and factorization scale uncertainty ################
#for ip in [2,3,4,5,7,9]:
#    uncertainty.append("FCNC_QCD_%s"%(str(ip)))    
############### FCNC parton shower uncertainty ################
#uncertainty.append("FCNC_PS_Up"      )
#uncertainty.append("FCNC_PS_Down"    )
#
############### DY PDF uncertainty ################
#for ip in range(2001,2103):
#    uncertainty.append("DY_PDF_%s"%(str(ip)))    
############### DY QCD : renormalization and factorization scale uncertainty ################
#for ip in ["1002","1003","1004","1005","1007","1009"]:
#    uncertainty.append("DY_QCD_%s"%(str(ip)))    
