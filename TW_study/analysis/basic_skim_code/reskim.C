...
///////////////////For TW stduy//////////////////////
        ...
        //if(ev_event==34642176 || ev_event==66835221)std::cout<<"ID="<<el->pass_VIDTight<<",pt="<<el->pt<<",fabs(eta)="<<fabs(el->eta)<<",region="<<el->region<<",fabs(sc_eta)="<<fabs(sc_eta)<<",fabs(gsf_dxy)="<<fabs(gsf_dxy)<<",fabs(gsf_dz)="<<fabs(gsf_dz)<<std::endl;
...
//#############   For save event ##########################
      //if(ev_event==34642176 || ev_event==66835221)std::cout<<"ele size="<<electrons.size()<<", mu size="<<muons.size()<<std::endl;
