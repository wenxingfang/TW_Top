...
###################### Only for LFV fast sim###########################
LFV_ST_gc_Olu_path=["/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/FLV/signalFastSimSamples/ST_13TeV_LFV_gc_Olu_Madgraph.root"]
LFV_ST_gc_Olu=run_obj("LFV_ST_gc_Olu_fastsim",0, 0, 0, 0, "", LFV_ST_gc_Olu_path,Ele23_Ele12_trigger,0 ,0 ,0 ,0)               
Run_data.append(LFV_ST_gc_Olu)
LFV_ST_gc_Olq_path=["/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/FLV/signalFastSimSamples/ST_13TeV_LFV_gu_Olq_Madgraph.root"]
LFV_ST_gc_Olq=run_obj("LFV_ST_gu_Olq_fastsim",0, 0, 0, 0, "", LFV_ST_gc_Olq_path,Ele23_Ele12_trigger,0 ,0 ,0 ,0)               
Run_data.append(LFV_ST_gc_Olq)
LFV_TT_Olu_path=["/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/FLV/signalFastSimSamples/TT_13TeV_LFVdecay_Olu_Madgraph.root"]
LFV_TT_Olu=run_obj("LFV_TT_Olu_fastsim",0, 0, 0, 0, "", LFV_TT_Olu_path,Ele23_Ele12_trigger,0 ,0 ,0 ,0)               
Run_data.append(LFV_TT_Olu)
