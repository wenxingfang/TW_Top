...
void TMVAtest()
{
  ...
  TString sigFileTrain = "MC_Data/_EMu_80_step1_T2/80_inc_ST_1j1b_EMu.root";
  TString bkgFileTrain_ttbar = "MC_Data/_EMu_80_step1_T2/80_inc_TT_1j1b_EMu.root";
  TString bkgFileTrain_DY = "MC_Data/_EMu_80_step1_T2/80_DYToLL_50_1j1b_EMu.root";
  TString bkgFileTrain_WW = "MC_Data/_EMu_80_step1_T2/80_WWTo2L2Nu_1j1b_EMu.root";
 ...
 if (!inputBTrain_ttbar) {
  ...
  factory->AddBackgroundTree( backgroundTrain_DY, 1.0);
  ...
  factory->BookMethod( TMVA::Types::kMLP, "MLP", "H:!V:NeuronType=sigmoid:VarTransform=N:NCycles=800:HiddenLayers=8:TestRate=10:EstimatorType=sigmoid" ); 
