...
find ./ -name "split_*"  -exec sed -i '1i cd /user/wenxing/Limits/CMSSW_7_4_7/src/LimitCode/TOP_EFT_0629/Check_limit/ProfileLikelihood/out_info/' {} \; #write echo "AllCompleted" in last
