...
input_path="/user/wenxing/Limits/CMSSW_7_4_7/src/LimitCode/TOP_EFT_0629/input_file_NoTopPtReW_1bin/"
output_path="/user/wenxing/Limits/CMSSW_7_4_7/src/LimitCode/TOP_EFT_0629/data_card_NoTopPtReW_1bin/"
        ...
        for ic in ["Cg"]:
            ...
            for sf in ["1.00"]:
                for do_opposite in [True,False]:
                    ...
                    f_info = open(info_path+"info_NoTopPtReW_1bin.txt",'r')
