...
input_path="/user/wenxing/Limits/CMSSW_7_4_7/src/LimitCode/TOP_EFT_0629/input_file_NoTopPtReW/"
output_path="/user/wenxing/Limits/CMSSW_7_4_7/src/LimitCode/TOP_EFT_0629/data_card_NoTopPtReW/"
        ...
        for ic in ["Ctw","Ctg","Cphiq"]:
            ...
            for sf in ["1.00"]:
                for do_opposite in [True,False]:
                    ...
                    f_info = open(info_path+"info_NoTopPtReW.txt",'r')
