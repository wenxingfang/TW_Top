...
script_path = "/user/wenxing/Limits/CMSSW_7_4_7/src/LimitCode/TOP_EFT_0629/Check_uncert/by_freeze_para/scripts/"
...
for cat in ['obs','exp']:
    ...
    for ic in ['Cg','Cphiq','Ctw','Ctg','Cug','Ccg']:
        ...
        for isys in system[ic]:
            ...
            str_cd = 'cd /user/wenxing/Limits/CMSSW_7_4_7/src/LimitCode/TOP_EFT_0629/Check_uncert/by_freeze_para/%s/%s'%(cat, ic)
            f_out.write(str_cd +'\n')
            f_out.write(str_evn+'\n')
            miniTol = '0.0001'
            if cat=='obs':
