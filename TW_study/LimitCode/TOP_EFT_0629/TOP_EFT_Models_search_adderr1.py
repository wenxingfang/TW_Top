...
class TopEFT_TWTT(PhysicsModel):
    ...
    def setModelBuilder(self, modelBuilder):
        ...
        self.modelBuilder.doVar("TT_sm[1.0,0.95,1.05]")
    ...
    def doParametersOfInterest(self):
        ...
        self.modelBuilder.factory_( "expr::TT_s_func(\"(@0)*%f + pow(@0,2)*%f + %f + @1 \", r,TT_sm)"%(self.TT_AinttoAsm,self.TT_AbsmtoAsm,self.TT_AsmnnlomnlotoAnlo))
