...
void select_save_parton( TString Uncert){
TString dir_in ="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/Phynomenological_study/Single_TOP/final_7TeV/";
TString dir_out="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/Phynomenological_study/Single_TOP/ntuple/Reza_7TeV_lastbin/";
if(Uncert=="nominal"){
fill_hist(dir_in+"vtb_top_7TeV.root"    , dir_out+"hist_Vtb_top_"+Uncert+".root",     Uncert);
fill_hist(dir_in+"vtb_antitop_7TeV.root", dir_out+"hist_Vtb_antitop_"+Uncert+".root", Uncert);
fill_hist(dir_in+"vts_top_7TeV.root"    , dir_out+"hist_Vts_top_"+Uncert+".root",     Uncert);
fill_hist(dir_in+"vts_antitop_7TeV.root", dir_out+"hist_Vts_antitop_"+Uncert+".root", Uncert);
fill_hist(dir_in+"vtd_top_7TeV.root"    , dir_out+"hist_Vtd_top_"+Uncert+".root",     Uncert);
fill_hist(dir_in+"vtd_antitop_7TeV.root", dir_out+"hist_Vtd_antitop_"+Uncert+".root", Uncert);
}
else if(Uncert=="PS_Down"){
dir_in ="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/Phynomenological_study/Single_TOP/Qscale_PS/";
fill_hist(dir_in+"Qcale_downst_antitop_tch_4f_Vtd_NLO_lepDecay_7TeV.root"    , dir_out+"hist_Vtd_antitop_"+Uncert+".root",     Uncert);
fill_hist(dir_in+"Qcale_downst_top_tch_4f_Vtd_NLO_lepDecay_7TeV.root"        , dir_out+"hist_Vtd_top_"+Uncert+".root"    ,     Uncert);
fill_hist(dir_in+"Qcale_downst_antitop_tch_4f_Vts_NLO_lepDecay_7TeV.root"    , dir_out+"hist_Vts_antitop_"+Uncert+".root",     Uncert);
fill_hist(dir_in+"Qcale_downst_top_tch_4f_Vts_NLO_lepDecay_7TeV.root"        , dir_out+"hist_Vts_top_"+Uncert+".root"    ,     Uncert);
}
else if(Uncert=="PS_Up"){
dir_in ="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/Phynomenological_study/Single_TOP/Qscale_PS/";
fill_hist(dir_in+"Qcale_upst_antitop_tch_4f_Vtd_NLO_lepDecay_7TeV.root"    , dir_out+"hist_Vtd_antitop_"+Uncert+".root",     Uncert);
fill_hist(dir_in+"Qcale_upst_top_tch_4f_Vtd_NLO_lepDecay_7TeV.root"        , dir_out+"hist_Vtd_top_"+Uncert+".root"    ,     Uncert);
fill_hist(dir_in+"Qcale_upst_antitop_tch_4f_Vts_NLO_lepDecay_7TeV.root"    , dir_out+"hist_Vts_antitop_"+Uncert+".root",     Uncert);
fill_hist(dir_in+"Qcale_upst_top_tch_4f_Vts_NLO_lepDecay_7TeV.root"        , dir_out+"hist_Vts_top_"+Uncert+".root"    ,     Uncert);
}
else{
fill_hist(dir_in+"vts_top_7TeV.root"    , dir_out+"hist_Vts_top_"+Uncert+".root",     Uncert);
fill_hist(dir_in+"vts_antitop_7TeV.root", dir_out+"hist_Vts_antitop_"+Uncert+".root", Uncert);
...
double Top_Pt_bin[6]={0,45,75,110,150,500};
double antiTop_Pt_bin[6]={0,45,75,110,150,500};
double rapid_bin[5]={0,0.2,0.6,1.1,3.0};
...
TH1D *H_atop_Rap_fine =new TH1D("H_atop_Rap_fine"      ,"",4,rapid_bin);
...
for(unsigned int ij=0;ij<mc_pdgId->size();ij++){
if( abs(mc_pdgId->at(ij))==6 && mc_status->at(ij)==62 ){
Top.SetPtEtaPhiE(mc_pt->at(ij),mc_eta->at(ij),mc_phi->at(ij),mc_energy->at(ij));
}
}
//------------------- Fill histograms--------------------------------------
