...
void select_save_comb(){
TString dir_in ="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/Phynomenological_study/Single_TOP/reza_final/";
TString dir_out="/user/wenxing/ST_TW_channel/CMSSW_8_0_25/src/Phynomenological_study/Single_TOP/ntuple/Reza_final/";
...
fill_hist(dir_in+"outfile_vtd_antitop.root", dir_out+"hist_Vtd_antitop.root", false);
fill_hist(dir_in+"outfile_vtd_top.root"    , dir_out+"hist_Vtd_top.root",     true );
fill_hist(dir_in+"outfile_vts_antitop.root", dir_out+"hist_Vts_antitop.root", false);
fill_hist(dir_in+"outfile_vts_top.root"    , dir_out+"hist_Vts_top.root",     true );
}
