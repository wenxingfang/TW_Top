...
void test(){
fill_hist("/pnfs/iihe/cms/store/user/wenxing/FINAL_sample/MC_0511_bjetsf/TTTo2L2Nu_TuneCUETP8M2_ttHtranche3_13TeV-powheg-pythia8_sumLHEweight/crab_TTTo2L2Nu_TuneCUETP8M2_ttHtranche3_13TeV-powheg-MiniAOD/170827_144420/0000/outfile_1.root"    , "./status7x_test.root",     true );
}
...
TH1D *H_S1_lep_M           =new TH1D("H_S1_lep_M"          ,"",100,100,200 );
...
//if(abs(mc_pdgId->at(ij))==6 && mc_status->at(ij)>=71 && mc_status->at(ij)<=79 ){
...
fill( H_S1_lep_M           ,top.M()                         ,mc_w_sign); 
}
                                               }
...
H_S1_lep_M       ->Write("",TObject::kOverwrite); 
